...
urlpatterns = [
    ...
    path('remove_from_budget_presupuesto/<int:material_id>/', views.remove_from_budget_presupuesto, name='remove_from_budget_presupuesto'),
    path('factura', views.factura, name='factura'),
    path('add_to_budget_factura/<int:material_id>/', views.add_to_budget_factura, name='add_to_budget_factura'),
